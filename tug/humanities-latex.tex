...
Here, I will model \textbf{polyglossia}, which is what I happen to be familiar with using for polytonic (ancient and Byzantine) Greek. \break
...
A language may be toggled for a single line like so:
...
which might be used to insert a keyword, e.g. {\textgreek{ὁ λόγος}} (\verb|\textgreek{ὁ λόγος}|), inside prose.
...
Designated packages for specific languages, e.g. \textbf{Serto} for Syriac \break 
